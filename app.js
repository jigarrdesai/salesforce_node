...
var cid = process.env.CLIENT_ID || "3MVG9szVa2RxsqBZefExH8IJOXZkxrBxEeTggAqTiGn8PDjpF_BEhsvl.6b8BTQvPr8S7rgzHXr88uFmfY0iT";
var csecr = process.env.CLIENT_SECRET || "5938069526296534047";
...
app.get('/accounts/new', function (req, res) {
	...
	rest.api(req).describe('Inventory__c', function (data) {
...
app.get('/accounts/:id', function (req, res) {
	rest.api(req).retrieve('Inventory__c', req.params.id, null, function (data) {
